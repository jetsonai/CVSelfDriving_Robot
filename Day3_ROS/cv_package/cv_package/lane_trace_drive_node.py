...
def main(args=None):
    ...
    src = np.float32([[94,90],[114, 86], [138, 82], [163, 79], [180, 76],[90, 103],[113, 100],[140, 97],[166, 92],[188, 88]])
    dst = np.float32([[22.5,5],[22.5,2.5],[22.5,0],[22.5,-2.5],[22.5,-5],[20,5],[20,2.5],[20,0],[20,-2.5],[20,-5]])
    Homo = Dist(src,dst)
    global bridge
    bridge = CvBridge()
