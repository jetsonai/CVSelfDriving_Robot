...
import math
from custom_msgctl.msg import MsgCtl #### motor control
...
class MotorCtlPublisher(Node):
    ...
    def motor_drive(self, goalx, goaly):
        ...
        center = 320./2.
        goalX = (float(goalx)/100.) - (center/100.)ch
...
def image_detection2(frame, network, class_names, class_colors, thresh):
    ...
    return frame, detect_num, X_dist, Y_dist
...
def main(args=None):
    ...
    rclpy.init()
    node = rclpy.create_node("ros_yolo_driving")
    ...
    while(True):
        ...
        motorctl_publisher.motor_drive(X_dist, Y_dist)
