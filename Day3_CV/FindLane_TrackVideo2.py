...
def motor_drive(goalx, goaly):
    global angle_last
    global steering_value
    global steering_dgain_value 
    global steering_bias_value 
...
cap = cv2.VideoCapture(inputfile_path)
...
while cap.isOpened():
    ...
    motor_drive(lane_center, lane_center_y)
