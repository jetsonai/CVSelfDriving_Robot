...
# Model
model = torch.hub.load('C:/Users/syhoo/KEA/yolov5','yolov5x', 'yolov5x.pt',source='local') 


vid = cv2.VideoCapture('C:/Users/syhoo/KEA/CVSelfDriving/test_img/video/KITTI_test11.mp4')
mot_tracker = Sort()
...
while(True):
    ...
    for j in range(len(track_bbs_ids.tolist())):
        ...
        cv2.putText(BirdEyeView, "Y_dist: " + str(int(Y_dist)), (V_center_x_int, V_center_y_int + 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)    
